...
public abstract class AbsDefinicoesLinguagem extends AbsDefinicoes {
    ...
    public final Token DOT = new Token(_DOT, getDOT(), getSymbol(), getDOT(), ++end);

    public static String _COMMA; // ,
    public String getCOMMA(){ return ","; }
    public final Token COMMA = new Token(_COMMA, getCOMMA(), getSymbol(), getCOMMA(), ++end);

    public static String _SEMICOLON; // ;
    public String getSEMICOLON(){ return ";"; }
    public final Token SEMICOLON = new Token(_SEMICOLON, getSEMICOLON(), getSymbol(), getSEMICOLON(), ++end);

    public static String _COLON; // :
    public String getCOLON(){ return ","; }
    public final Token COLON = new Token(_COLON, getCOLON(), getSymbol(), getCOLON(), ++end);

    public static String _DOUBLECOLON; // ::
    public String getDOUBLECOLON(){ return ";"; }
    public final Token DOUBLECOLON = new Token(_DOUBLECOLON, getDOUBLECOLON(), getSymbol(), getDOUBLECOLON(), ++end);

    public static String _ASSIGNMENT_OPERATOR; // :=
    public String getASSIGNMENT_OPERATOR(){ return ":="; }
    public final Token ASSIGNMENT_OPERATOR = new Token(_ASSIGNMENT_OPERATOR, getASSIGNMENT_OPERATOR(), getSymbol(), getASSIGNMENT_OPERATOR(), ++end);

    public static String _DOUBLE_DOT; // ..
    public String getDOUBLE_DOT(){ return ".."; }
    public final Token DOUBLE_DOT = new Token(_DOUBLE_DOT, getDOUBLE_DOT(), getSymbol(), getDOUBLE_DOT(), ++end);

    public static String _SINGLE_QUOTE; // '
    public String getSINGLE_QUOTE(){ return "'"; }
    public final Token SINGLE_QUOTE = new Token(_SINGLE_QUOTE, getSINGLE_QUOTE(), getSymbol(), getSINGLE_QUOTE(), ++end);

    public static String _DOUBLE_QUOTE; // "
    public String getDOUBLE_QUOTE(){ return "\""; }
    public final Token DOUBLE_QUOTE = new Token(_DOUBLE_QUOTE, getDOUBLE_QUOTE(), getSymbol(), getDOUBLE_QUOTE(), ++end);

    public static String _LEFT_PARENTHESES; // (
    public String getLEFT_PARENTHESES(){ return "("; }
    public final Token LEFT_PARENTHESES = new Token(_LEFT_PARENTHESES, getLEFT_PARENTHESES(), getSymbol(), getLEFT_PARENTHESES(), ++end);

    public static String _RIGHT_PARENTHESES; // )
    public String getRIGHT_PARENTHESES(){ return ")"; }
    public final Token RIGHT_PARENTHESES = new Token(_RIGHT_PARENTHESES, getRIGHT_PARENTHESES(), getSymbol(), getRIGHT_PARENTHESES(), ++end);

    public static String _LEFT_AND_RIGHT_PARENTHESES; // ()
    public String getLEFT_AND_RIGHT_PARENTHESES(){ return "()"; }
    public final Token LEFT_AND_RIGHT_PARENTHESES = new Token(_LEFT_AND_RIGHT_PARENTHESES, getLEFT_AND_RIGHT_PARENTHESES(), getSymbol(), getLEFT_AND_RIGHT_PARENTHESES(), ++end);
    
    public static String _LEFT_BRACKETS; // [
    public String getLEFT_BRACKETS(){ return "["; }
    public final Token LEFT_BRACKETS = new Token(_LEFT_BRACKETS, getLEFT_BRACKETS(), getSymbol(), getLEFT_BRACKETS(), ++end);
    
    public static String _RIGHT_BRACKETS; // ]
    public String getRIGHT_BRACKETS(){ return "]"; }
    public final Token RIGHT_BRACKETS = new Token(_RIGHT_BRACKETS, getRIGHT_BRACKETS(), getSymbol(), getRIGHT_BRACKETS(), ++end);

    public static String _LEFT_AND_RIGHT_BRACKETS; // []
    public String getLEFT_AND_RIGHT_BRACKETS(){ return "[]"; }
    public final Token LEFT_AND_RIGHT_BRACKETS = new Token(_LEFT_AND_RIGHT_BRACKETS, getLEFT_AND_RIGHT_BRACKETS(), getSymbol(), getLEFT_AND_RIGHT_BRACKETS(), ++end);

    public static String _LEFT_BRACES; // {
    public String getLEFT_BRACES(){ return "{"; }
    public final Token LEFT_BRACES = new Token(_LEFT_BRACES, getLEFT_BRACES(), getSymbol(), getLEFT_BRACES(), ++end);

    public static String _RIGHT_BRACES; // }
    public String getRIGHT_BRACES(){ return "}"; }
    public final Token RIGHT_BRACES = new Token(_RIGHT_BRACES, getRIGHT_BRACES(), getSymbol(), getRIGHT_BRACES(), ++end);

    public static String _LEFT_AND_RIGHT_BRACES; // {}
    public String getLEFT_AND_RIGHT_BRACES(){ return "{}"; }
    public final Token LEFT_AND_RIGHT_BRACES = new Token(_LEFT_AND_RIGHT_BRACES, getLEFT_AND_RIGHT_BRACES(), getSymbol(), getLEFT_AND_RIGHT_BRACES(), ++end);

    public static String _EQUAL_SIGN; // =
    public String getEQUAL_SIGN(){ return "="; }
    public final Token EQUAL_SIGN = new Token(_EQUAL_SIGN, getEQUAL_SIGN(), getSymbol(), getEQUAL_SIGN(), ++end);

    public static String _GREATER_THAN_SIGN; // >
    public String getGREATER_THAN_SIGN(){ return ">"; }
    public final Token GREATER_THAN_SIGN = new Token(_GREATER_THAN_SIGN, getGREATER_THAN_SIGN(), getSymbol(), getGREATER_THAN_SIGN(), ++end);

    public static String _LESS_THAN_SIGN; // <
    public String getLESS_THAN_SIGN(){ return "<"; }
    public final Token LESS_THAN_SIGN = new Token(_LESS_THAN_SIGN, getLESS_THAN_SIGN(), getSymbol(), getLESS_THAN_SIGN(), ++end);

    public static String _GREATER_THAN_OR_EQUAL_TO_SIGN; // >=
    public String getGREATER_THAN_OR_EQUAL_TO_SIGN(){ return ">="; }
    public final Token GREATER_THAN_OR_EQUAL_TO_SIGN = new Token(_GREATER_THAN_OR_EQUAL_TO_SIGN, getGREATER_THAN_OR_EQUAL_TO_SIGN(), getSymbol(), getGREATER_THAN_OR_EQUAL_TO_SIGN(), ++end);

    public static String _LESS_THAN_OR_EQUAL_TO_SIGN; // <=
    public String getLESS_THAN_OR_EQUAL_TO_SIGN(){ return "<="; }
    public final Token LESS_THAN_OR_EQUAL_TO_SIGN = new Token(_LESS_THAN_OR_EQUAL_TO_SIGN, getLESS_THAN_OR_EQUAL_TO_SIGN(), getSymbol(), getLESS_THAN_OR_EQUAL_TO_SIGN(), ++end);
    
    public static String _NOT_EQUAL_TO_SIGN; // <>
    public String getNOT_EQUAL_TO_SIGN(){ return "<>"; }
    public final Token NOT_EQUAL_TO_SIGN = new Token(_NOT_EQUAL_TO_SIGN, getNOT_EQUAL_TO_SIGN(), getSymbol(), getNOT_EQUAL_TO_SIGN(), ++end);

    public static String _PLUS_SIGN; // +
    public String getPLUS_SIGN(){ return "+"; }
    public final Token PLUS_SIGN = new Token(_PLUS_SIGN, getPLUS_SIGN(), getSymbol(), getPLUS_SIGN(), ++end);
    
    public static String _MINUS_SIGN; // -
    public String getMINUS_SIGN(){ return "-"; }
    public final Token MINUS_SIGN = new Token(_MINUS_SIGN, getMINUS_SIGN(), getSymbol(), getMINUS_SIGN(), ++end);

    public static String _ASTERISK_OR_MULTIPLICATION_SIGN; // *
    public String getASTERISK_OR_MULTIPLICATION_SIGN(){ return "*"; }
    public final Token ASTERISK_OR_MULTIPLICATION_SIGN = new Token(_ASTERISK_OR_MULTIPLICATION_SIGN, getASTERISK_OR_MULTIPLICATION_SIGN(), getSymbol(), getASTERISK_OR_MULTIPLICATION_SIGN(), ++end);

    public static String _FORWARD_SLASH_OR_DIVISION_SIGN; // /
    public String getFORWARD_SLASH_OR_DIVISION_SIGN(){ return "/"; }
    public final Token FORWARD_SLASH_OR_DIVISION_SIGN = new Token(_FORWARD_SLASH_OR_DIVISION_SIGN, getFORWARD_SLASH_OR_DIVISION_SIGN(), getSymbol(), getFORWARD_SLASH_OR_DIVISION_SIGN(), ++end);

    public static String _CARET_OR_EXPONENTIATION_SIGN; // ^
    public String getCARET_OR_EXPONENTIATION_SIGN(){ return "^"; }
    public final Token CARET_OR_EXPONENTIATION_SIGN = new Token(_CARET_OR_EXPONENTIATION_SIGN, getCARET_OR_EXPONENTIATION_SIGN(), getSymbol(), getCARET_OR_EXPONENTIATION_SIGN(), ++end);

    public static String _PERCENT_SIGN; // %
    public String getPERCENT_SIGN(){ return "%"; }
    public final Token PERCENT_SIGN = new Token(_PERCENT_SIGN, getPERCENT_SIGN(), getSymbol(), getPERCENT_SIGN(), ++end);    
}
